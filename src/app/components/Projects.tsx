      ...
      >
        {projects.map((project) => (
          <motion.article
            ...
            {...cardHoverSmall}
          >
            {/* Whole card clickable linking to video page */}
            <Link href={`/video/${project.slug}`} className="block hover:no-underline">
              <motion.div
            ...
            {/* GitHub link outside Link wrapper to avoid nested <a> tags */}
            <div
